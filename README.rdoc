...
This fork of Inherited Resources makes the smallest changes necessary to get it to work with MongoMapper. It is compatible
with MongoMapper as of version 0.7.0.

=== Back to Inherited Resources
